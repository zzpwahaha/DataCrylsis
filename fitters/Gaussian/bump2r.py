...
def fitCharacter(params):
    [Offset, Amp1, Pos1, Amp2, Pos2, Sigma] = params
...
def fitCharacterErr(params, errs):
    [Offset, Amp1, Pos1, Amp2, Pos2, Sigma] = params
    [Offset_e, Amp1_e, Pos1_e, Amp2_e, Pos2_e, Sigma_e] = errs
...
def args():    
    arglist = ['Offset', "Amp1", "Pos1", "Amp2", "Pos2", "Sigma"]
    return arglist

def f(x, Offset, Amp1, Pos1, Amp2, Pos2, Sigma):
    """[[0,0.3,-150,10, 0.3, 150, 10]]
    The normal function call for this function. Performs checks on valid arguments, then calls the "raw" function.
    :return:
    """
    params = [Offset, Amp1, Pos1, Sigma, Amp2, Pos2, Sigma]
...
def f_unc(x, Offset, Amp1, Pos1, Amp2, Pos2, Sigma):
    """
...
def sbcGuess():
    return [[0.05, 0.6, -160, 0.1, 150, 10]]
